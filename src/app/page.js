...
import { 
  ...
  PlusCircle, Languages, RefreshCw, Package, Cat, MapPin, AlertTriangle, ExternalLink, Building2, Phone, Stethoscope
} from 'lucide-react';
  ...
  return (
    <main className="min-h-screen bg-[#09090b] text-zinc-100 antialiased selection:bg-cyan-500 selection:text-black">
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-6 lg:py-8 space-y-6 lg:space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
          ...
          <aside className="lg:col-span-3 space-y-4 lg:space-y-6 lg:sticky lg:top-28">
            ...
            {/* MENÚ MÓVIL EN MATRIZ DE 1 COLUMNA COMPLETA */}
            ...
            <button className="hidden lg:flex w-full bg-linear-to-r from-cyan-500 to-teal-500 hover:from-cyan-400 hover:to-teal-400 text-zinc-950 font-extrabold py-4 rounded-xl transition-all duration-300 items-center justify-center gap-2.5 shadow-[0_4px_20px_rgba(34,211,238,0.15)] active:scale-[0.99]">
      ...
      <div className="lg:hidden fixed bottom-6 left-5 right-5 z-50">
        <button className="w-full bg-linear-to-r from-cyan-500 to-teal-500 text-zinc-950 font-black py-4 rounded-xl shadow-[0_8px_30px_rgba(34,211,238,0.25)] flex items-center justify-center gap-2 active:scale-[0.98] transition-transform">
          <PlusCircle className="h-5 w-5 stroke-[2.5]" />
          <span className="text-base tracking-tight">{t.reportar}</span>
        </button>
      </div>
